...
import { getAllUser, getUserById as getUserByIdService, updateUser as updateUserService, deleteUser as deleteUserService } from "../services/user.service.js"
...
export const updateUser = async(req,res,next)=>{
    try {
        ...
        if(!isAdmin && Object.prototype.hasOwnProperty.call(updates, 'role')){
            return res.status(403).json({ error:'Forbidden: only admin can update role' })
        }
